...
function EditFarm({ match }) {
  ...
  const handleEditFarm = event => {
    ...
    fetch(process.env.REACT_APP_API_URL + '/updateFarm/' + match.params.id, {
      method: 'PUT',
      mode: 'cors',
      cache: 'no-cache',
      headers: {
  ...
  useEffect(() => {
    ...
    function getFarmData() {
      fetch(process.env.REACT_APP_API_URL + '/getFarm/' + match.params.id)
  ...
  const deleteFarm = (id) => {
    fetch(process.env.REACT_APP_API_URL + '/deleteFarm/' + match.params.id, {
      method: 'DELETE',
      mode: 'cors',
      cache: 'no-cache',
      headers: {
